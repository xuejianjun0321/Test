 ...
 * @version $Id: BaseResultCodeEnum.java, v 0.1 2017年10月14日 上午10:25:48 LIU Kunpeng Exp $
 */
public enum BaseResultCodeEnum implements EnumBase {
    ...
    /** 链接异常 */
    CONN_ERROR("CONN_EXCE", "连接异常", 10000017),
    ...
    INVOKE_IS_REJECT("INVOKE_IS_REJECT", "被限制的调用", 10000021);
    ...
    /**
     *
     * @see com.timevale.mandarin.base.enum.EnumBase#message()
     */
    @Override
